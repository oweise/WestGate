...
public class WGUserProfile extends WGDocument {
     ...
     * @throws WGAPIException
     */
    public void addNewSession(String ip, String sessionId) throws WGAPIException {
        ...
        this.setMetaData(META_LASTSESSIONID, sessionId);
        ...
        if (getDatabase().getContentStoreVersion() >= WGDatabase.CSVERSION_WGA5) {
            this.setMetaData(META_LASTIP, ip);
        }

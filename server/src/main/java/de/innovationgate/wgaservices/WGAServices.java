...
public interface WGAServices {
     ...
     */
    public ActionResult callAction(RemoteSession session, String dbKey, String actionID, String executionContext,
            List<Object> params, Form form) throws WGAServiceException;

...
public class PluginOperationException extends PluginException {
    ...
    private WorkspaceOperation _operation;

    public PluginOperationException(WorkspaceOperation op, String string) {
        super(string);
        _operation = op;
    }

    public PluginOperationException(WorkspaceOperation op, String string, Exception e) {
        super(string, e);
        _operation = op;
    }

...
public class TMLPageWrapper extends ScriptableObject implements Wrapper {
    ...
    public static void render(Context cx, Scriptable thisObj, Object[] args, Function funObj) throws JavaScriptException, WGException, NoSuchMethodException, SecurityException {
        ((TMLPageWrapper) thisObj).instanceRender(cx, thisObj, args, funObj);
    }

    @SuppressWarnings("unchecked")
    private void instanceRender(Context cx, Scriptable thisObj, Object[] args, Function funObj) throws WGException, JavaScriptException, NoSuchMethodException, SecurityException {

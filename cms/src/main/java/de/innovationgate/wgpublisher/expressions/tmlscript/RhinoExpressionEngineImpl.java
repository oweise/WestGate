        ...
        public Object run(Context cx) {
            ...
            try {
                ...
                try {
                    ...
                    return createExpressionResult(null, new WGExpressionException("Error creating tmlscript context", _expression, exc));
                }
                ...
                // Some syntax error
                    ...
                    expressionException = new WGExpressionException(exceptionMessage, exc.lineSource(), cause, scriptStackTrace);
                    return createExpressionResult(null, expressionException);
                }
                
                // A script timeout
                catch (TimeoutError err) {
                    return createExpressionResult(null, new WGExpressionException("Script execution timed out after " + err.getTimeout() + " milliseconds.",
                            _expression));
                }
                ...
                // Some java script error explicitly thrown by the code: Converted to TMLScriptException so the class can be better used outside
                    ...
                    WGExpressionException expressionException = new WGExpressionException(exceptionMessage, exc.lineSource(), convertToTMLScriptException(exc), filterScriptStackTrace(exc.getScriptStackTrace()));
                    return createExpressionResult(null, expressionException);
                }
                ...
                // Everything else: Wrapped java exceptions, internal rhino malfunctionings etc.
                    ...
                    return createExpressionResult(null, new WGExpressionException("Exception executing tmlscript: " + cause.getClass().getName() + " - Message:" +cause.getMessage() + ".\n"
                ...
                return createExpressionResult(null, new WGExpressionException("Unexpected exception: " + e.getClass().getName() + ": " + e.getMessage(),

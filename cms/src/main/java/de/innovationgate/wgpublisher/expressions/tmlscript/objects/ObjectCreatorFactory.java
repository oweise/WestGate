...
public interface ObjectCreatorFactory {
    public ObjectCreator constructObjectCreator(RhinoContext cx, TMLAction objectDefinition, Script script,
            TMLScriptObjectParentScope parentScope) throws WGException, IOException, ClassNotFoundException;

...
public class Master extends ScriptableObject {
    ...
    public static Object runFunction(Context cx, Scriptable thisObj, Object[] args, Function funObj) {
        try {
    ...
    public static Object runMethod(Context cx, Scriptable thisObj, Object[] args, Function funObj) {
        try {
            RhinoExpressionEngineImpl runtime = WGAGlobal.fetchRuntime(cx);

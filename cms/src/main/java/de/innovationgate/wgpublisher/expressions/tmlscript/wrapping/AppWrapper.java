...
public class AppWrapper extends ScriptableObject implements Wrapper {
    ...
    static {
        _managedGlobalVarargs = (new VarArgParser("managedGlobal"))
                ...
                .add("ref", new Class[] {Design.class, Function.class}, false)
    ...
    public static void managedGlobal(Context cx, Scriptable thisObj, Object[] args, Function funObj) throws JavaScriptException, WGException, ClassNotFoundException, IllegalArgumentException, IOException {

...
public class ContentDatabasePublisherOptionsCollector extends OptionsCollector {

    public String getDescription(Locale locale) {
        return "Object collecting all registered publisher options";
    }

    public Class<? extends ModuleType> getModuleType() {
        return ContentDatabasePublisherOptionsModuleType.class;
    }

    public String getTitle(Locale locale) {
        return "Content Database Publisher options collector";
    }

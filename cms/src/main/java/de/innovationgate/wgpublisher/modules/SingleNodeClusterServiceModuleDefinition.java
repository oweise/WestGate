...
public class SingleNodeClusterServiceModuleDefinition implements ModuleDefinition {
    ...
    public String getDescription(Locale locale) {
        return "Single (local) only node cluster";
    }
    ...
    public Class<? extends ModuleType> getModuleType() {
        return ClusterServiceModuleType.class;
    }

    @Override
    public Class<? extends Object> getImplementationClass() {
        return SingleNodeClusterService.class;
    }

...
public class FileAnnotatorsValueProvider extends ModuleDefinitionsValueProvider {
    
    public FileAnnotatorsValueProvider(ModuleRegistry reg) {
        super(reg, FileAnnotatorModuleType.class.getName());
    }

    public String getEmptyListMessage(Locale locale) {
        return "No file annotators registered? This most certainly is an error...";
    }

...
public class ImageScalerFactoryApiModuleDefinition implements ModuleDefinition, KeyBasedModuleDefinition {
    ...
    public String getTitle(Locale locale) {
        return _bundleLoader.getBundle(locale).getString("scalerfactory.title");
    }

    @Override
    public String getDescription(Locale locale) {
        return _bundleLoader.getBundle(locale).getString("scalerfactory.description");
    }
    ...
    public Object getProperties() {
        ...
        props.setDefaultImplementation(ImgScalrScalerFactory.class);
        return props;
    }

    @Override
    public String getRegistrationKey() {
        return MimeTypeSpecificImageScalerFactory.class.getName();
    }

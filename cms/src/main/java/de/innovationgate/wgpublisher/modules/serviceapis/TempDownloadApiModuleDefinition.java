...
import de.innovationgate.wgpublisher.TemporaryDownloadService;

public class TempDownloadApiModuleDefinition implements ModuleDefinition, KeyBasedModuleDefinition {
    ...
    public String getTitle(Locale locale) {
        return _bundleLoader.getBundle(locale).getString("tmpdwn.title");
    }

    @Override
    public String getDescription(Locale locale) {
        return _bundleLoader.getBundle(locale).getString("tmpdwn.description");
    }
    ...
    public Class<? extends Object> getImplementationClass() {
        return TemporaryDownloadService.class;
    }
    ...
    public String getRegistrationKey() {
        return TemporaryDownloadService.class.getName();
    }

...
public class LanguageBehavioursOptionType implements OptionType {
    
    private ModuleRegistry _reg;

    public LanguageBehavioursOptionType(ModuleRegistry reg) {
        _reg = reg;
    }
    ...
    public OptionValueProvider getValueProvider(WGAConfiguration configCopy) {
        return new LanguageBehavioursValueProvider(_reg);
    }

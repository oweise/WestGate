...
public class FileDerivateCreatorsOptionType extends CommaSeparatedListOptionType implements OptionType {
    ...
    public void validate(String value, Locale locale, ValidationContext cx) throws OptionValueValidationException {
        ...
        while (values.hasNext()) {
            ...
            if (!providedValues.contains(singleValue)) {
                throw new OptionValueValidationException("The file derivate creator type '" + singleValue + "' is unknown");
            }
        }
    }

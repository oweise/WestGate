...
import de.innovationgate.wgpublisher.webtml.form.PortletConfigFormSource;
import de.innovationgate.wgpublisher.webtml.form.UserProfileFormSource;

public class PortletConfigFormSourceModuleDefinition implements ModuleDefinition, KeyBasedModuleDefinition {

    @Override
    public String getTitle(Locale locale) {
        return "Portlet configuration form source";
    }

    @Override
    public String getDescription(Locale locale) {
        return "Form source retrieving/storing form items from/as WebTML portlet configuration items";
    }
    ...
    public Class<? extends Object> getImplementationClass() {
        return PortletConfigFormSource.class;
    }

...
public class ItemEncodingValueProvider implements OptionValueProvider {
    ...
    public ItemEncodingValueProvider(ModuleRegistry reg) {
        _reg = reg;
    }
    ...
    public String getEmptyListMessage(Locale arg0) {
        return _bundleLoader.getBundle(arg0).getString("option.itemencoding.emptylist.message");
    }

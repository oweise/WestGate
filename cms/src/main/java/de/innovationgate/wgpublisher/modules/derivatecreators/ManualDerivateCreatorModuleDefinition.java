...
import de.innovationgate.wgpublisher.files.derivates.ManualDerivateCreator;
import de.innovationgate.wgpublisher.files.derivates.ThumbnailDerivateCreator;

public class ManualDerivateCreatorModuleDefinition implements ModuleDefinition {
    
    private LocalisationBundleLoader _bundleLoader = new LocalisationBundleLoader(WGUtils.getPackagePath(this.getClass()) + "/manual", getClass().getClassLoader());
    ...
    public Class<? extends Object> getImplementationClass() {
        return ManualDerivateCreator.class;
    }

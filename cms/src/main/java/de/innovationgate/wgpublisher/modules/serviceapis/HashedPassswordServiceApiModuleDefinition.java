...
import de.innovationgate.wgpublisher.HashedPasswordService;

public class HashedPassswordServiceApiModuleDefinition implements ModuleDefinition, KeyBasedModuleDefinition {
    ...
    public String getTitle(Locale locale) {
        return _bundleLoader.getBundle(locale).getString("hashedpassword.title");
    }

    @Override
    public String getDescription(Locale locale) {
        return _bundleLoader.getBundle(locale).getString("hashedpassword.description");
    }
    ...
    public Class<? extends Object> getImplementationClass() {
        return HashedPasswordService.class;
    }
    ...
    public Object getProperties() {
        ...
        props.setDefaultImplementation(HashedPasswordService.class);
        return props;
    }
    
    @Override
    public String getRegistrationKey() {
        return HashedPasswordService.class.getName();
    }

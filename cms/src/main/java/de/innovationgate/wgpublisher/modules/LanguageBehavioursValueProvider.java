...
public class LanguageBehavioursValueProvider extends ModuleDefinitionsValueProvider {
    
    public LanguageBehavioursValueProvider(ModuleRegistry reg) {
        super(reg, LanguageBehaviourModuleType.class.getName());
    }

    public String getEmptyListMessage(Locale locale) {
        return "No language behaviours registered? This most certainly is an error...";
    }

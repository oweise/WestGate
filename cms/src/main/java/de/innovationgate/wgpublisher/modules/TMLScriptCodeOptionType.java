...
public class TMLScriptCodeOptionType extends MultilineStringOptionType {
    
    public static TMLScriptCodeOptionType INSTANCE = new TMLScriptCodeOptionType();
    
    private TMLScriptCodeOptionType() {
    }

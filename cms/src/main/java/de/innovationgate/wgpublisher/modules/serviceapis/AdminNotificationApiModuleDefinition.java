...
import de.innovationgate.wgpublisher.WGAAdminNotificationService;

public class AdminNotificationApiModuleDefinition implements ModuleDefinition, KeyBasedModuleDefinition {
    ...
    public String getTitle(Locale locale) {
        return _bundleLoader.getBundle(locale).getString("adminmail.title");
    }

    @Override
    public String getDescription(Locale locale) {
        return _bundleLoader.getBundle(locale).getString("adminmail.description");
    }
    ...
    public Class<? extends Object> getImplementationClass() {
        return WGAAdminNotificationService.class;
    }
    ...
    public String getRegistrationKey() {
        return WGAAdminNotificationService.class.getName();
    }

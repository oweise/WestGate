...
public class NewContentFormSourceModuleDefinition implements ModuleDefinition, KeyBasedModuleDefinition {

    @Override
    public String getTitle(Locale locale) {
        return "Empty form source";
    }

    @Override
    public String getDescription(Locale locale) {
        return "Form source without backend data, suitable to create new content documents";
    }

...
public class UserProfileFormSourceModuleDefinition implements ModuleDefinition, KeyBasedModuleDefinition {

    @Override
    public String getTitle(Locale locale) {
        return "User profile form source";
    }

    @Override
    public String getDescription(Locale locale) {
        return "Form source retrieving/storing form items from/as user profile items";
    }
    ...
    public Class<? extends Object> getImplementationClass() {
        return UserProfileFormSource.class;
    }

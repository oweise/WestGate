...
public class LongRequestProblemType implements ProblemType, UseSpecialProblemImplementation {
    ...
    public String getDescription(Locale l) {
        return "Collects URL paths whose requests exceed " + WGAFilter.REQUEST_LENGTH_NOTIFICATION_THRESHOLD + " milliseconds runtime";
    }
    ...
    public Problem createProblem(ProblemPath problemPath, ProblemText text, ProblemSeverity severity, ProblemOccasion occasion, Throwable throwable, List<MessageVariableProvider> providers) {
        return new LongRequestProblem(problemPath, text, severity, occasion, throwable, providers);
    }

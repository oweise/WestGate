...
/**
 * Variant of {@link DefaultURLBuilder} which also is used for independent TMLScript environments which do not have a WebTML request.
 */
public class RequestIndependentDefaultURLBuilder extends DefaultURLBuilder implements RequestIndependentURLBuilder {
    
    @Override
    public void newIndependentInstance(WGACore core) {
        _core = core;
    }

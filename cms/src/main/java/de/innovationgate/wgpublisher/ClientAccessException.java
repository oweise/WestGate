 ...
 * @see WGACore.openContentDBCertAuth(), WGACore.openContentDB()
 *
 */
public class ClientAccessException extends WGAServerException {
    ...
    public ClientAccessException(String msg, Throwable cause) {
        super(msg, cause);
    }

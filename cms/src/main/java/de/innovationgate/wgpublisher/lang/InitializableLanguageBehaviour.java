...
/**
 * A language behaviour that is aware of its database and may read settings from it
 */
public interface InitializableLanguageBehaviour extends LanguageBehaviour {

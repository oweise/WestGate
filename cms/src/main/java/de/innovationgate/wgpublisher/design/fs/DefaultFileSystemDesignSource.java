...
public class DefaultFileSystemDesignSource extends FileSystemDesignSource {
    ...
    protected String determinePath(WGACore core, Map<String, String> options) {
        ...
        if (dir != null) {
            ...
            return WGAConfiguration.DEFAULT_DESIGNROOT;
        }
    ...
    public String getDescription(Locale locale) {
        return "Designs from folder " + getDir().getName().getPath();
    }

...
/**
 * WGA specific extension to the {@link WGDesignProvider} interface
 */
public interface WGADesignProvider extends WGDesignProvider {
    
    public static final String OPTION_DESIGNVARIANTS = "variants";

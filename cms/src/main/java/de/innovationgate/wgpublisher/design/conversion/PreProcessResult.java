...
public class PreProcessResult {
    ...
    private Map<String,Object> _extensionData = new HashMap<String, Object>();
    private  Class<? extends PostProcessor> _postProcessor = null; 

    public Class<? extends PostProcessor> getPostProcessor() {
        return _postProcessor;
    }

    public void setPostProcessor( Class<? extends PostProcessor> postProcessor) {

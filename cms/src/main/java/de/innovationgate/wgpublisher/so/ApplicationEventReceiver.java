...
public class ApplicationEventReceiver {
    ...
    private Map<String,Object> _scopeEventParams = new HashMap<String, Object>();
    private WGA _wga;
    
    public ApplicationEventReceiver(WGA wga, ScopeObjectRegistry reg) {
        _scopeObjectRegistry = reg;
        _wga = wga;
    }

    public Map<String, Object> getScopeEventParams() {
        return _scopeEventParams;
    }
    ...
    public WGA getEventEnvironment() {
        return _wga;
    }

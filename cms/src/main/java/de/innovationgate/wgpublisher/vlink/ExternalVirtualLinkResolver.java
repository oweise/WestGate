...
public class ExternalVirtualLinkResolver implements VirtualLinkResolver {

    @Override
    public VirtualLinkTarget resolve(WGA wga, WGContent content) throws WGException {
        VirtualLinkTarget target = new VirtualLinkTarget(Type.EXTERNAL);
        target.setExternalUrl(content.getVirtualLink());
        return target;
    }

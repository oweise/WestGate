    	...
    	if (_config != null) {
            ...
            try {
                ...
                if (e.getCause() instanceof LicenseException) {
                    _wgaCore.getProblemRegistry().addProblem(Problem.create(new UpdateConfigOccasion(), new DomainScope(getName()), "updateConfigProblem.domainAuthLicenseError", ProblemSeverity.HIGH, e));
                }
                else {
                    _wgaCore.getProblemRegistry().addProblem(Problem.create(new UpdateConfigOccasion(), new DomainScope(getName()), "updateConfigProblem.domainAuthFailed", ProblemSeverity.HIGH, e));
                }
            }
            ...
            if (persDBConfig != null && persDBConfig.isEnabled()) {
	            ...
	            if (serverConfig == null || serverConfig.isEnabled()) {
    	            ...
    	            try {
                        ...
                        _wgaCore.getProblemRegistry().addProblem(Problem.create(new UpdateConfigOccasion(), new DomainScope(getName()), "updateConfigProblem.domainPersFailed", ProblemSeverity.HIGH, e));
                    }

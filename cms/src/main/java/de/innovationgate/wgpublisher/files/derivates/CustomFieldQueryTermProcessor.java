...
public class CustomFieldQueryTermProcessor implements DerivateQueryTermProcessor {
    ...
    public float matchTermToFileAnnotations(WGFileAnnotations fileAnnotations, DerivateQueryTerm term, ClientHints clientHints) throws WGException {
        ...
        Object value = fileAnnotations.getCustomFieldValue(term.getName());
        if (String.valueOf(value).equals(term.getValue())) {
            return 1;
        }
        else {
            return 0;

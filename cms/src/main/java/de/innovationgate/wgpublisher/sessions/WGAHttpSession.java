...
public class WGAHttpSession implements HttpSession, de.innovationgate.wgpublisher.sessions.api.WGAHttpSession, Serializable {
    ...
    private static Logger LOG = Logger.getLogger(WGAHttpSession.class);
    ...
    private void fireUnboundEvent(String key, Object att) {
        try {
            ...
            LOG.error("Failed to dispatch HttpSessionBindingEvent for attribute '" + att + "'." , e);
        }
    }
    ...
    public void setAttribute(String key, Object value) {
        ...
        LOG.warn("WGAHttpSession: ignored null value for key '" + key + "'");
        if (value != null && value instanceof HttpSessionBindingListener) {
            try {
                HttpSessionBindingEvent event = new HttpSessionBindingEvent(this, key, value);
                ((HttpSessionBindingListener)value).valueBound(event);
            } catch (Throwable e) {
                LOG.error("Failed to dispatch HttpSessionBindingEvent for attribute '" + value + "'." , e);
            }
        }
    }

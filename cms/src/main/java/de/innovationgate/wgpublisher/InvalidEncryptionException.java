 ...
 */
public class InvalidEncryptionException extends WGException {

    public InvalidEncryptionException(String msg) {
        super(msg);
    }

    public InvalidEncryptionException(String msg, Throwable cause) {
        super(msg, cause);
    }

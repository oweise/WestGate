...
public class Inline extends Option {
    ...
    protected Object retrieveOptionValue(Object tagResult) throws WGException {
        ...
        WGPDeployer deployer = CDI.current().select(WGPDeployer.class).get();
        DeployedLayout layout = deployer.deployInlineTML(mod, "option \"" + this.getName() + "\" on line " + getSourceline(), String.valueOf(optionValue), Integer.parseInt(getSourceline()), getPageContext().getRequest());

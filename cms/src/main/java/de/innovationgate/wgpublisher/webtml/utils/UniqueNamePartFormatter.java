...
public class UniqueNamePartFormatter implements ObjectFormatter {
    
    public static UniqueNamePartFormatter INSTANCE = new UniqueNamePartFormatter();
    
    private UniqueNamePartFormatter() {
    }

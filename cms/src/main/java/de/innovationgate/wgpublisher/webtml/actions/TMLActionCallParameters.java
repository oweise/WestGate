...
public class TMLActionCallParameters {
    
    private String _ajaxMode;
    private String _portletMode;
    private String _portletContext;
    private String _relevantForm;
    ...
    public String getRelevantForm() {
        return _relevantForm;
    }
    public void setRelevantForm(String relevantForm) {
        _relevantForm = relevantForm;
    }

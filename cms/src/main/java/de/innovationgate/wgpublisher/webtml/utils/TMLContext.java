...
import de.innovationgate.utils.URIUtil;
...
public class TMLContext implements TMLObject, de.innovationgate.wga.server.api.tml.Context {
     ...
     * @param encode Optional WebTML encoding. Use null to have none.
   ...
   @Override
	 ...
	 * @param db The database for whom the preferred language is determined. It is used to evaluate the available languages and to read it's language behaviour setting
     ...
     */
    private String createDataURL(String data, String contentType) {
        StringBuffer url = new StringBuffer();
        url.append("data:");
        if (contentType != null) {
            url.append(contentType);            
    ...
    @CodeCompletion
    public Document loadhtml(HttpClient client, String url) throws UnsupportedEncodingException, WGAPIException, IOException,
    ...
    public Document loadhtml(String url)
            throws UnsupportedEncodingException, WGAPIException, IOException, SAXException, HttpException {
        try {
    ...
    public PortletEvent fetchRequestPortletEvent() {
        ...
        // Event originally thrown from databaseServer

...
public class NoneEncodingFormatter implements ObjectFormatter {
    
    public static final NoneEncodingFormatter INSTANCE = new NoneEncodingFormatter();
    
    private NoneEncodingFormatter() {
    }

 ...
 */
public class HDBModelFormValidationFailedException extends WGHierarchicalDatabaseEventCanceledException {

    private static final long serialVersionUID = 1L;

    public HDBModelFormValidationFailedException(WGHierarchicalDatabaseEvent event) {
        super(event, "Form validation failed");
    }

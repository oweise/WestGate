...
public interface WGACoreServices extends WGAServices {
     ...
     * @throws WGAServiceException
     */
    public void createDatabase(RemoteSession session, DatabaseServerInfo dbServerInfo, String implClassName,
     ...
     * @throws WGAServiceException
     */
    public DataSource createContentStoreDump(RemoteSession session, String dbKey, boolean includeACL,
            boolean includeSystemAreas) throws WGAServiceException;
     ...
     * @throws WGAServiceException
     */
    public List<DatabaseInformation> getAvailableDatabases(RemoteSession session, DatabaseServerInfo dbServerInfo,
            String implClassName) throws WGAServiceException;

...
public interface ClientFactoryService {
     ...
     */
    public WGACustomServices createCustomServiceClient(String wgaRootURL, Map<String, Object> properties) throws MalformedURLException,
            WGAServiceException;
     ...
     * @throws WGAServiceException
     */
    public WGACoreServices createCoreServiceClient(String wgaRootURL, Map<String, Object> properties) throws MalformedURLException,
            WGAServiceException;

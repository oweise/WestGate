...
public class PluginStore {
        ...
        if (cachedPlugins != null) {
            ...
            try {
                ...
                for (String uname : pluginsRaw.keySet()) {
                    @SuppressWarnings("unchecked") PluginStorePlugin plugin = PluginStorePlugin.createFrom(uname, (Map<String,Object>)pluginsRaw.get(uname));
    ...
    public List<PluginStorePlugin> getDependencies(Environment environment, PluginStorePlugin plugin) throws  IOException {
        ...
        try {
            ...
            for (String uname : pluginsRaw.keySet()) {
                @SuppressWarnings("unchecked") PluginStorePlugin currentPlugin = PluginStorePlugin.createFrom(uname, (Map<String,Object>)pluginsRaw.get(uname));

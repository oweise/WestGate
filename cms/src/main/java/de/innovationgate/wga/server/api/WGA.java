...
public class WGA {
    ...
    /**
     * Dividing character for WebTML scohomePageMethodping, dividing the scope qualifier from the scoped data
     */
    ...
    public static WGA get(ServletContext servletContext) {
        ...
        final WGACore core = CDI.current().select(WGACore.class).get();
        return new WGA(new WGAContext() {

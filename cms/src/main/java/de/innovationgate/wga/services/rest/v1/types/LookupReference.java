...
public class LookupReference extends Reference {
    ...
    public LookupReference(String id, URI uri, String extensionParam, String resourceTypeParam, String lookupTypeParam) {
        this(Id.create(id), uri, extensionParam, resourceTypeParam, lookupTypeParam);
    }
    
    public LookupReference(Id id, URI uri, String extensionParam, String resourceTypeParam, String lookupTypeParam) {

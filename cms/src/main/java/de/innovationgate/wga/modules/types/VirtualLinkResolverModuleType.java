...
public class VirtualLinkResolverModuleType implements DeclaringModuleType {

    @Override
    public String getTitle() {
        return "Virtual Link Resolver Module Type";
    }

    @Override
    public String getDescription() {
        return "Module to resolve virtual links, based on their type";
    }
    ...
    public Class<? extends Object> getImplementationBaseClass() {
        return VirtualLinkResolver.class;
    }

...
public class ClusterServiceModuleType implements DeclaringModuleType {

    @Override
    public String getTitle() {
        return "cluster service module type";
    }

    @Override
    public String getDescription() {
        return "Modules of this type provide cluster communication services to be used in OpenWGA";
    }

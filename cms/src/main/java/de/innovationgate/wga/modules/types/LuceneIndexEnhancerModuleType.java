...
import de.innovationgate.wgpublisher.lucene.LuceneIndexEnhancer;

public class LuceneIndexEnhancerModuleType implements DeclaringModuleType {

    @Override
    public String getTitle() {
        return "lucene index enhancer module type";
    }

    @Override
    public String getDescription() {
        return "Module type for lucene index enhancer implementations";
    }
    ...
    public Class<? extends Object> getImplementationBaseClass() {
        return LuceneIndexEnhancer.class;
    }

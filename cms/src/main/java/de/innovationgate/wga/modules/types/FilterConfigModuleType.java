...
public class FilterConfigModuleType implements DeclaringModuleType {

    public String getDescription() {
        return "Configurations for servlet filters to be automatically added to WGA filter chain";
    }

    public String getTitle() {
        return "Filter configuration type";
    }

...
public class FileAnnotatorModuleType implements DeclaringModuleType {

    @Override
    public String getTitle() {
        return "File annotator module type";
    }

    @Override
    public String getDescription() {
        return "File annotators to annotate attached files and created file derivates with additional metadata";
    }

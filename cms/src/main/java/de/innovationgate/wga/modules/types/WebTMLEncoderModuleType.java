 ...
 */
public class WebTMLEncoderModuleType implements DeclaringModuleType {

    public String getDescription() {
        return "Legacy WebTML encoders, keyed by their encoder name. For implementing modern WGA encoders use " + WGAEncoderModuleType.class.getName();
    }

    public String getTitle() {
        return "WebTML encoder module type (legacy)";
    }

...
public class TMLFormSourceModuleType implements DeclaringModuleType {

    @Override
    public String getTitle() {
        return "WebTML form source module type";
    }

    @Override
    public String getDescription() {
        return "Data source backends to be used with WebTML forms";
    }

...
public class FileDerivateCreatorModuleType implements DeclaringModuleType {

    @Override
    public String getTitle() {
        return "File Derivate Creator Module Type";
    }

    @Override
    public String getDescription() {
        return "Creators of file derivates for file attachments";
    }
    ...
    public Class<? extends Object> getImplementationBaseClass() {
        return FileDerivateCreator.class;
    }

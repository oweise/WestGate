...
public class HTMLHeadInclusionModuleType implements DeclaringModuleType {

    public String getDescription() {
        return "Defines additional code to be put out in the HTML head upon usage of <tml:htmlhead>";
    }

    public String getTitle() {
        return "HTML head inclusion type";
    }
    ...
    public Class<? extends Object> getImplementationBaseClass() {
        return HTMLHeadInclusion.class;
    }

 ...
 */
public class WebTMLElementModuleType implements DeclaringModuleType {

    public String getDescription() {
        return "WebTML elements, keyed by their element name";
    }

    public String getTitle() {
        return "WebTML element module type";
    }

...
public class ContentDatabasePublisherOptionsModuleType implements DeclaringModuleType {

    public String getDescription() {
       return "Objects providing publisher options as option definitions";
    }

    public String getTitle() {
        return "Publisher options type";
    }

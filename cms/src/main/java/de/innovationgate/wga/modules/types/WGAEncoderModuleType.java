 ...
 */
public class WGAEncoderModuleType implements DeclaringModuleType {

    public String getDescription() {
        return "OpenWGA encoders, keyed by their encoder name";
    }

    public String getTitle() {
        return "OpenWGA encoder module type";
    }
